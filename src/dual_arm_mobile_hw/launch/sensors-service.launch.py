...
def generate_launch_description():
    ...
    launch_file_lidar2d_0 = PathJoinSubstitution([pkg_dual_arm_mobile_hw, "launch", "lidar2d_0.launch.py"])
    launch_file_lidar2d_1 = PathJoinSubstitution([pkg_dual_arm_mobile_hw, "launch", "lidar2d_1.launch.py"])
